...
public class MammothRenderer : MonoBehaviour
{
    ...
    public bool RemapToOtherHand;
    public RemapCoordinator RemapCoordinator;
    ...
    private void GetPointSnapshot()
    {
        ...
        List<Transform> activeContacts;
        if (RemapToOtherHand == true) {
            activeContacts = RemapCoordinator.GetRemappedTransforms(_contacts, _bufferPointsCount);
        }
        else {
            activeContacts = _contacts;
        }
